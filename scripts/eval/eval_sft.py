...
def main():
    ...
    # ----------  DoProj MetricsRecorder 集成 ----------
    exp_id = cfg.get("exp_id", "exp_002")
    phase = cfg.get("phase", "sft_eval")
    metrics_cfg = cfg.get("metrics", {})
    recorder = MetricsRecorder(
        exp_id=exp_id,
        phase=phase,
        results_dir=cfg["output"]["dir"],
    ...
    if args.split_file and seen_ids:
        ...
        recorder.write_json(split_report, "split_eval_report.json")
